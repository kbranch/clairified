...
<div class="py-1">
  ...
  <label class="btn" :for="`${element}-weak`" v-tooltip="`Weak to ${element}`">W</label>
  ...
  <label class="btn" :for="`${element}-normal`" v-tooltip="`Normal ${element} damage`">N</label>
  ...
  <label class="btn" :for="`${element}-resist`" v-tooltip="`Resistant to ${element}`">R</label>
  ...
  <label class="btn" :for="`${element}-immune`" v-tooltip="`Immune to ${element}`">I</label>
  ...
  <label class="btn" :for="`${element}-absorb`" v-tooltip="`Absorbs ${element}`">A</label>
</div>
